"""
This script is called by the plugin-wrapper, PetriNetClassification.js, which passes down the
...
from PetriNetClassification import PetriNetClassification
...
plugin = PetriNetClassification(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
